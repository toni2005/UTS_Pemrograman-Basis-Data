...
--
-- Host: 127.0.0.1
-- Generation Time: 07 Nov 2023 pada 15.09
...
CREATE TABLE `mahasiswa` (
  ...
  `nama_mhs` char(100) DEFAULT NULL,
...
INSERT INTO `mahasiswa` (`id_mahasiswa`, `NIM`, `nama_mhs`, `jenis_kelamin`, `thn_masuk`, `alamat`) VALUES
